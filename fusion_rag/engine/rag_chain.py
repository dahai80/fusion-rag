...
class DocumentChain:
    ...
    @staticmethod
    async def stuff(docs: list[str], query: str, mlx_url: str = "http://localhost:11432/v1") -> str:
    ...
    @staticmethod
    async def refine(docs: list[str], query: str, mlx_url: str = "http://localhost:11432/v1") -> str:
    ...
    @staticmethod
    async def map_reduce(docs: list[str], query: str, mlx_url: str = "http://localhost:11432/v1") -> str:
